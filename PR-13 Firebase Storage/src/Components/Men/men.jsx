...
//       (product) =>
//         product.category &&
//         product.category.toString().trim().toLowerCase() === "men"
//     );
//   }, [products]);
...
//     let filtered = menCategoryProducts;
...
const MenCardData = () => {
  ...
  // ✅ NEW: Navigate to Single Product Page
            ...
            {filteredProducts.length > 0 ? (
              filteredProducts.map((item) => (
                <Card
                  ...
                  onClick={() => handleProductClick(item.id)} // ✅ Added
                >
                  <Card.Img
                    variant="top"
                    src={item.image}
                  ...
                  <Card.Body>
                    ...
                    <div className="d-flex justify-content-between">
                      <Button
                        variant="warning"
                        onClick={(e) => {
                          e.stopPropagation(); // 👈 prevent click from opening single page
                          handleEdit(item.id);
                        }}
                      >
                        Edit
